...
wrf_lat = wrf_file1.variables["XLAT"][0,:,0]
wrf_lon = wrf_file1.variables["XLAT"][0,0,:]
...
ds= Dataset(r"F:\WRF-CHEM ANALYSIS\column_integrated_sum_jun.nc",mode='w',format='NETCDF4')
...
value.units = 'column_integrated_sum ug/m2'

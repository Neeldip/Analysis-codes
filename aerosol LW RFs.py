...
wrf_file = Dataset(r"K:\WRF_Chem_Output\202\April\no_emiss_IGP\wrfout_d01_2018-04-10_00%3A00%3A00")
...
print("DIRECT EFFECT+ SEMI-DIRECT+ INDIRECT ALL SKY LW RF SURFACE")
...
print("DIRECT EFFECT+ SEMI-DIRECT+ INDIRECT ALL SKY LW RF TOA")
...
print("DIRECT EFFECT+ SEMI-DIRECT+ INDIRECT ALL SKY LW RF ATM")
...
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 6\radiative forcing\TOTAL LW RADIATIVE FORCING_SURFACE_ALLSKY_no_emiss_IGP.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 6\radiative forcing\TOTAL LW RADIATIVE FORCING_TOA_ALLSKY_no_emiss_IGP.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 6\radiative forcing\TOTAL LW RADIATIVE FORCING_ATM_ALLSKY_no_emiss_IGP.png",dpi=600,bbox_inches='tight')
...
RF_SURFACE_ALLSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("INDIRECT ALL SKY LW RF SURFACE")
precp1 = RF_SURFACE_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SURFACE_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_TOA_ALLSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("INDIRECT ALL SKY LW RF TOA")
precp1 = RF_TOA_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_TOA_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#######################################ALL SKY ATMOSPHERIC RADIATIVE FORCING##################################
RF_ATM_ALLSKY = RF_TOA_ALLSKY-RF_SURFACE_ALLSKY
print("INDIRECT ALL SKY LW RF ATM")
precp1 = RF_ATM_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_ATM_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#plt.figure(figsize=(8,6))
plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\INDIRECT LW RADIATIVE FORCING_SURFACE_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\INDIRECT LW RADIATIVE FORCING_TOA_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\INDIRECT LW RADIATIVE FORCING_ATM_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT+SEMI LW RADIATIVE FORCING_SURFACE_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT+SEMI LW RADIATIVE FORCING_TOA_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT+SEMI LW RADIATIVE FORCING_ATM_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT LW RADIATIVE FORCING_SURFACE_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT LW RADIATIVE FORCING_TOA_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\DIRECT LW RADIATIVE FORCING_ATM_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\SEMI-DIRECT LW RADIATIVE FORCING_SURFACE.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\SEMI-DIRECT LW RADIATIVE FORCING_TOA.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\SEMI-DIRECT LW RADIATIVE FORCING_ATM.png",dpi=600,bbox_inches='tight')

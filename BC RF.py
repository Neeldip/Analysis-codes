...
print("DIRECT +SEMI-DIRECT ALL SKY NET RF SURFACE")
...
print("DIRECT +SEMI-DIRECT ALL SKY NET RF TOA")
...
print("DIRECT +SEMI-DIRECT ALL SKY NET RF ATM")
...
print("DIRECT CLEAR SKY NET RF SURFACE")
...
print("DIRECT CLEAR SKY NET RF TOA")
...
print("DIRECT CLEAR SKY NET RF ATM")
...
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI NET RADIATIVE FORCING_SURFACE_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI NET RADIATIVE FORCING_TOA_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI NET RADIATIVE FORCING_ATM_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT NET RADIATIVE FORCING_SURFACE_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT NET RADIATIVE FORCING_TOA_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT NET RADIATIVE FORCING__ATM_CLEARSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT NET RADIATIVE FORCING_SURFACE.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT NET RADIATIVE FORCING_TOA.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT NET RADIATIVE FORCING_ATM.png",dpi=600,bbox_inches='tight')
...
RF_SURFACE_ALLSKY = ((CLD_1)-(CLD1_1))-((CLD2_1)-(CLD3_1))
print("DIRECT +SEMI-DIRECT ALL SKY SW RF SURFACE")
precp1 = RF_SURFACE_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SURFACE_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_TOA_ALLSKY = ((CLD_1) - (CLD1_1)) - ((CLD2_1) - (CLD3_1))
print("DIRECT +SEMI-DIRECT ALL SKY SW RF TOA")
precp1 = RF_TOA_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_TOA_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#######################################ALL SKY ATMOSPHERIC RADIATIVE FORCING##################################
RF_ATM_ALLSKY = RF_TOA_ALLSKY-RF_SURFACE_ALLSKY
print("DIRECT +SEMI-DIRECT ALL SKY SW RF ATM")
precp1 = RF_ATM_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_ATM_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_SURFACE_CLEARSKY = ((CLD_1)-(CLD1_1))-((CLD2_1)-(CLD3_1))
print("DIRECT CLEAR SKY SW RF SURFACE")
precp1 = RF_SURFACE_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SURFACE_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_TOA_CLEARSKY = ((CLD_1)-(CLD1_1))-((CLD2_1)-(CLD3_1))
print("DIRECT CLEAR SKY SW RF TOA")
precp1 = RF_TOA_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_TOA_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#######################################CLEAR SKY ATMOSPHERIC RADIATIVE FORCING##################################
RF_ATM_CLEARSKY = RF_TOA_CLEARSKY-RF_SURFACE_CLEARSKY
print("DIRECT CLEAR SKY SW RF ATM")
precp1 = RF_ATM_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_ATM_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#plt.figure(figsize=(8,6))
plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI SW RADIATIVE FORCING_SURFACE_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI SW RADIATIVE FORCING_TOA_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI SW RADIATIVE FORCING_ATM_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT SW RADIATIVE FORCING_SURFACE_CLEARSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_CLEARSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT SW RADIATIVE FORCING_TOA_CLEARSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_CLEARSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT SW RADIATIVE FORCING_ATM_CLEARSKY.png",dpi=600,bbox_inches='tight')


#############################SEMI DIRECT EFFECT###############################
RF_SEMI_SURFACE=RF_SURFACE_ALLSKY-RF_SURFACE_CLEARSKY
print("SEMI DIRECT RF SW SURFACE")
precp1 = RF_SEMI_SURFACE[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SEMI_SURFACE[157:186, 216:252]
print(np.nanmean(precp1))
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT SW RADIATIVE FORCING_SURFACE.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_SEMI_TOA,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT SW RADIATIVE FORCING_TOA.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_SEMI_ATM,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT SW RADIATIVE FORCING_ATM.png",dpi=600,bbox_inches='tight')
...
RF_SURFACE_ALLSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("DIRECT +SEMI-DIRECT ALL SKY LW RF SURFACE")
precp1 = RF_SURFACE_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SURFACE_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_TOA_ALLSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("DIRECT +SEMI-DIRECT ALL SKY LW RF TOA")
precp1 = RF_TOA_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_TOA_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#######################################ALL SKY ATMOSPHERIC RADIATIVE FORCING##################################
RF_ATM_ALLSKY = RF_TOA_ALLSKY-RF_SURFACE_ALLSKY
print("DIRECT +SEMI-DIRECT ALL SKY LW RF ATM")
precp1 = RF_ATM_ALLSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_ATM_ALLSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_SURFACE_CLEARSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("DIRECT CLEAR SKY LW RF SURFACE")
precp1 = RF_SURFACE_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SURFACE_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
RF_TOA_CLEARSKY = ((CLD)-(CLD1))-((CLD2)-(CLD3))
print("DIRECT CLEAR SKY LW RF TOA")
precp1 = RF_TOA_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_TOA_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#######################################CLEAR SKY ATMOSPHERIC RADIATIVE FORCING##################################
RF_ATM_CLEARSKY = RF_TOA_CLEARSKY-RF_SURFACE_CLEARSKY
print("DIRECT CLEAR SKY LW RF ATM")
precp1 = RF_ATM_CLEARSKY[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_ATM_CLEARSKY[157:186, 216:252]
print(np.nanmean(precp1))
...
#plt.figure(figsize=(8,6))
plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI LW RADIATIVE FORCING_SURFACE_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI LW RADIATIVE FORCING_TOA_ALLSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_ALLSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT+SEMI LW RADIATIVE FORCING_ATM_ALLSKY.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT LW RADIATIVE FORCING_SURFACE_CLEARSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_TOA_CLEARSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT LW RADIATIVE FORCING_TOA_CLEARSKY.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_ATM_CLEARSKY,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS DIRECT LW RADIATIVE FORCING_ATM_CLEARSKY.png",dpi=600,bbox_inches='tight')

#############################SEMI DIRECT EFFECT###############################
RF_SEMI_SURFACE=RF_SURFACE_ALLSKY-RF_SURFACE_CLEARSKY
print("SEMI DIRECT RF LW SURFACE")
precp1 = RF_SEMI_SURFACE[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = RF_SEMI_SURFACE[157:186, 216:252]
print(np.nanmean(precp1))
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT LW RADIATIVE FORCING_SURFACE.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_SEMI_TOA,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT LW RADIATIVE FORCING_TOA.png",dpi=600,bbox_inches='tight')

plt.contourf(lons, lats, RF_SEMI_ATM,v, cmap=plt.get_cmap("bwr"),antialiased=False,transform=cartopy.crs.PlateCarree(),extend='both')
#plt.title("TSK difference",weight='bold',fontdict=font)
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\radiative forcing\BC ABS SEMI-DIRECT LW RADIATIVE FORCING_ATM.png",dpi=600,bbox_inches='tight')

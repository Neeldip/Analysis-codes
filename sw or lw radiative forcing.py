...
wrf_file = Dataset(r"H:\WRF_Chem_Output\201\April\MYNN3_no_bc_dust_emission\wrfout_d01_2018-04-10_00%3A00%3A00")
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_ATM_CLEARSKY_NOBCDUSTEMISS-NOFEED.png",dpi=600,bbox_inches='tight')

...
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_SURFACE_ALLSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_TOA_ALLSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_ATM_ALLSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_SURFACE_CLEARSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_TOA_CLEARSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')
...
#plt.figure(figsize=(8,6))
#plt.colorbar(ax=ax, shrink=.81, ticks=v)
plt.savefig(r"F:\WRF-CHEM ANALYSIS\radiative forcing\RADIATIVE FORCING_RF_ATM_CLEARSKY_NOR-WRF.png",dpi=600,bbox_inches='tight')

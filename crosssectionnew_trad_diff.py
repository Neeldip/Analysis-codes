...
#trad1 = Dataset(r"G:\WRF_Chem_Output\202\NO_BC_ABS\wrf_trad_fields_d01_2018-04-10_00%3A00%3A00")
trad1 =  Dataset(r"K:\WRF_Chem_Output\202\April\only_emiss_ne\wrfout_d01_2018-04-10_00%3A00%3A00")
...
# Add a title
#ax_cross.set_title("TEMPERATURE(aer_feedback - bc_no_absorbtion) (K) ", {"fontsize": 16})
pyplot.savefig(r'F:\WRF-CHEM ANALYSIS Chap 6\WRF level analysis\QVAPOR\QVAPOR_no_emiss_ne-only_emiss_ne'+str(cross_start)+str(cross_end)+'.png',dpi=600,bbox_inches='tight')
pyplot.show()

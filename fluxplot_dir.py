...
wrf_file = [Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-10_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-11_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-12_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-13_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-14_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-15_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-16_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-17_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-18_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-19_00%3A00%3A00"),
            Dataset(r"H:WRF_Chem_Output\201\March\wrfout_d01_2018-03-20_00%3A00%3A00")]
'''
'''
trad = [Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-10_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-11_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-12_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-13_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-14_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-15_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-16_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-17_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-18_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-19_00%3A00%3A00"),
        Dataset(r"H:\WRF_Chem_Output\201\March\wrf_trad_fields_d01_2018-02-20_00%3A00%3A00"),]
'''
...
y = X#(SPD*X)/K                     ##For single time or mean,use this, unit = ug/m^2*s
...
# Add a title
ax_cross.set_title("dir (ug m^-2 s-1) ", {"fontsize": 16})
#ax_cross.set_title("QCLOUD (g/kg) ", {"fontsize" : 14})

pyplot.savefig("dir_time="+str(time)+"coord="+str(cross_start)+"_"+str(cross_end)+".png",dpi=300,bbox_inches='tight')
pyplot.show()
#'''
...
ax_cross.set_title("dir (ug m^-2 s-1) ", {"fontsize": 16})
#ax_cross.set_title("QCLOUD (g/kg) ", {"fontsize" : 14})
pyplot.savefig("dir_time="+str(time)+"coord="+str(cross_start)+"_"+str(cross_end)+".png",dpi=300)
pyplot.show()

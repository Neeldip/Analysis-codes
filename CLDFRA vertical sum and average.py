...
CLD_DIFF = CLD# ((x - z))/10**7   #* 100  # 0000#*1000000000 ###*100 FOR BETTER READABILITY
...
plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\WRF level analysis\cldfra\CLDFRA_NOR_vertical sum.png",dpi=600, bbox_inches='tight')
plt.show()

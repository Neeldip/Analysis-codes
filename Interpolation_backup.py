...
ts = pd.read_excel('E:\DATA\Hourly_surface_data\Guwahati-2018\DS3505\Pre2018.xlsx')  # READ EXCEL FILE
...
dt = pd.date_range("2018-04-01 00:00:00", "2018-05-01 00:00:00", freq='30min',
...
with pd.ExcelWriter('File1.xlsx',
                    mode='a') as writer:

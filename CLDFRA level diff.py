...
#wrf_file = Dataset(r"K:\WRF_Chem_Output\202\April\only_emiss_ne\wrfout_d01_2018-04-10_00%3A00A00%3")
...
for y in level:
    ...
    plt.savefig(r"F:\WRF-CHEM ANALYSIS Chap 5\WRF level analysis\QVAPOR\QVAPOR_NOFEED-NOCHEM_AT_LEVEL =" + str(y) + ".png",dpi=600, bbox_inches='tight')
    plt.show()

...
from goodness_of_fit import mae,d,rmse,me,r_pearson
...
wrf =  Dataset(r"G:\WRF_Chem_Output\202\MYNN3_WRF\wrfout_d01_2018-04-10_00%3A00%3A00")

wrf_lat= wrf.variables["XLAT"][0,:,0]
wrf_lon = wrf.variables["XLONG"][0,0,:]

fn = r'F:\WRF-CHEM ANALYSIS Chap 5\rainfall\apr_rainfall_evaluation_NOCHEM.nc'   #<----------------

...
#fn = r'F:\WRF-CHEM ANALYSIS Chap 5\rainfall\RAINNC_amount_by_frequency_NOR-NOFEED_trial.nc'   #<----------------
...
for i in range(0,231,1):
    ...
    #    else:
            RAIN= wrf.variables['RAINNC'][0:241,i,j]#+wrf.variables['RAINNC'][0:241,i,j]
            RAIN1 = wrf1.variables['RAINNC'][0:241, i, j]# + wrf1.variables['RAINNC'][0:241, i, j]
            rain= RAIN[1:241]-RAIN[0:240]
            rain1 = RAIN1[1:241] - RAIN1[0:240]
            rain_diff=rain1-rain
            rain_total[i,j]=np.sum(rain_diff)
...
print("low inc")
precp1 = rain_total[157:186, 174:216]
print(np.nanmean(precp1))
precp1 = rain_total[157:186, 216:252]
print(np.nanmean(precp1))
precp1 = rain_total[186:203, 216:252]
print(np.nanmean(precp1))
precp1 = rain_total[123:157, 200:237]
print(np.nanmean(precp1))
precp1 = rain_total[168:178, 174:216]
print(np.nanmean(precp1))
'''
print("moderate inc")

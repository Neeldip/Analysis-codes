...
ds = open_mfdataset(r"I:\MERRA2_AOD\March\Combined\*.nc",combine='by_coords',concat_dim='time')
...
plt.title("AOD_MERRA2_March_2012-2018mean")
plt.savefig('F:\AOD_ANALYSIS\MERRA2_March_2012-2018-mean.png',dpi=300,bbox_inches='tight')
plt.show()